...
def __lambda_16(args,body):
  return {"t": "Lambda","args": args,"body": body,}
def __lambda_17(props):
  return {"t": "Array","props": props,}
def __lambda_18(k,v):
  return {"t": "Prop","k": k,"v": v,}
def __lambda_19(props):
  return {"t": "Object","props": props,}
def __lambda_20(obj,prop,computed):
  return {"t": "Member","obj": obj,"prop": prop,"computed": computed,}
Tokens = {"Int": 0,"Str": 1,"Word": 2,"BinOp": 3,"Equals": 4,"Dot": 5,"Comma": 6,"Colon": 7,"Semi": 8,"POpen": 9,"PClose": 10,"BOpen": 11,"BClose": 12,"SOpen": 13,"SClose": 14,"EIf": 15,"NEIf": 16,"Smaller": 17,"Bigger": 18,"And": 19,"Or": 20,"Import": 21,"Fn": 22,"Ret": 23,"If": 24,"Else": 25,"For": 26,"While": 27,"Class": 28,"Async": 29,"Try": 30,"Catch": 31,"EOF": 32,}
Nodes = {"Main": __lambda_1,"Assign": __lambda_2,"ImportStmt": __lambda_3,"FnStmt": __lambda_4,"RetStmt": __lambda_5,"IfStmt": __lambda_6,"ForStmt": __lambda_7,"WhileStmt": __lambda_8,"ClassStmt": __lambda_9,"TryCatch": __lambda_10,"Fcall": __lambda_11,"BinOp": __lambda_12,"Word": __lambda_13,"Int": __lambda_14,"Str": __lambda_15,"Lambda": __lambda_16,"Array": __lambda_17,"Prop": __lambda_18,"Object": __lambda_19,"Member": __lambda_20,}
